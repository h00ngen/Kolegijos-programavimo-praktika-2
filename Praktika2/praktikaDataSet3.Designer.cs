...
namespace Praktika2.praktikaDataSet3TableAdapters {
    ...
    public partial class groupsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[groups] ([groupname]) VALUES (@groupname);\r\nSELECT groupname F" +
                "ROM groups WHERE (groupname = @groupname)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[groups] SET [groupname] = @groupname WHERE (([groupname] = @Origina" +
                "l_groupname));\r\nSELECT groupname FROM groups WHERE (groupname = @groupname)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT groupname FROM dbo.groups";
        ...
        public virtual int Fill(praktikaDataSet3.groupsDataTable dataTable) {
        ...
        public virtual praktikaDataSet3.groupsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            praktikaDataSet3.groupsDataTable dataTable = new praktikaDataSet3.groupsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(praktikaDataSet3.groupsDataTable dataTable) {
